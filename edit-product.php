...
<body>
        ...
        <div class="product-page">
            ...
            <div class="product-header">
                <div class="product-title">
                    <h1>Edit Product</h1>
                    <p>Update product info, manage quantity variants, replace/remove image, and apartments.</p>
                </div>
            </div>
            ...
            <div class="product-form-card">
                ...
                <div class="form-card-header">
                    ...
                    <div>
                        ...
                        <span>Changes save on Update. Replacing the image deletes the old file.</span>
                    </div>
                    <span class="prod-code-badge" id="prodCodeBadge">—</span>
                </div>
                ...
                <form id="productForm" class="product-form" method="POST" novalidate style="display:none;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-icon-wrap">
                                <i class="bi bi-bag"></i>
                                <input type="text" id="product_name" class="product-input"
                    ...
                    <div class="variants-section">
                        ...
                        <div class="variants-head">
                            <div>
                                ...
                                <p>Update, add or remove variants (e.g. 500g → ₹120, 1kg → ₹220).</p>
                            </div>
                        ...
                        <div class="apartments-box" id="apartmentsBox">
                            ...
                            <div class="apartments-head" id="apartmentsHead">
                                <div class="apartments-head-title">
                                    ...
                                    <div>
                                        <h4>Apartment Management<span class="required">*</span></h4>
                            ...
                            <div class="apartments-body" id="apartmentsBody">
                                ...
                                <div class="apt-search">
                                    <i class="bi bi-search"></i>
                                    <input type="text" id="aptSearchInput"
    ...
    <div class="mm-modal-overlay" id="confirmOverlay" aria-hidden="true">
        <div class="mm-modal" role="dialog" aria-modal="true">
            ...
            <p class="mm-modal-text">This will delete the current product image when you save.</p>
    ...
    <script src="<?= ADMIN_URL; ?>js/edit-product.js"></script>
