...
<head>
    ...
    <style>
        ...
        .apartment-table tr:last-child td { border-bottom: none; }
        .apartment-table tbody tr { transition: .2s ease; }
        .apartment-table tbody tr:hover { background: #fffdf9; }
        ...
        .status-active { background: #e8f1e8; color: #52745b; }
        .status-inactive { background: #f4ecec; color: #8b5a5a; }
        ...
        .mm-btn-cancel:hover { background: #faf7f0; color: #302923; }
        ...
        .mm-btn-danger:hover { background: #8e1722; }
        .mm-btn-danger:disabled { opacity: .7; cursor: not-allowed; }
        ...
        .mm-toast-body { flex: 1; padding-top: 3px; line-height: 1.5; }
        ...
        .mm-toast-close:hover { color: #302923; }
        .mm-toast.success .mm-toast-icon { background: #4caf50; }
        .mm-toast.error .mm-toast-icon { background: #c62828; }
        .mm-toast.info .mm-toast-icon { background: #3b82f6; }


        @media (max-width: 768px) {
            .apartment-page { padding: 20px 15px 30px; }
            .apartment-header { flex-direction: column; align-items: flex-start; }
            .add-apartment-btn { width: 100%; justify-content: center; }
            .apartment-list-card { padding: 17px; border-radius: 17px; }
...
<body>
        ...
        <div class="apartment-page">
            ...
            <div class="apartment-header">
                ...
                <div class="apartment-title">
                    <h1>Apartments</h1>
                    <p>Manage apartment divisions and delivery charges.</p>
                </div>

                <a href="add-apartment.php" class="add-apartment-btn">
            ...
            <div class="apartment-list-card">

                <div class="list-header">

                    <div class="list-title">
                        <h3>Apartment List</h3>
                        <span>All apartments loaded from the database</span>
                    </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="apartment-table" id="apartmentTable">

                        <thead>
                            <tr>
                                <th>Apartment</th>
                                <th>Divisions &amp; Charges</th>
                                <th>Address</th>
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
    ...
    <div class="mm-modal-overlay" id="mmModalOverlay" aria-hidden="true">
        <div class="mm-modal" role="dialog" aria-modal="true" aria-labelledby="mmModalTitle">
            <div class="mm-modal-icon">
                <i class="bi bi-exclamation-triangle-fill"></i>
            </div>
            <h3 class="mm-modal-title" id="mmModalTitle">Delete Apartment?</h3>
            <p class="mm-modal-text" id="mmModalText">
                This action cannot be undone.
            </p>
            <div class="mm-modal-actions">
                <button type="button" class="mm-btn mm-btn-cancel" id="mmModalCancel">
                    Cancel
                </button>
    ...
    <script src="<?= ADMIN_URL; ?>js/apartment.js"></script>
